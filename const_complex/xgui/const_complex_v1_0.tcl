...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "INT_IMAG_PART_OUT_VALUE" -parent ${Page_0}
...
proc update_PARAM_VALUE.INT_IMAG_PART_OUT_VALUE { PARAM_VALUE.INT_IMAG_PART_OUT_VALUE } {
	# Procedure called to update INT_IMAG_PART_OUT_VALUE when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.INT_IMAG_PART_OUT_VALUE { PARAM_VALUE.INT_IMAG_PART_OUT_VALUE } {
	# Procedure called to validate INT_IMAG_PART_OUT_VALUE
	return true
}
...
proc update_MODELPARAM_VALUE.INT_IMAG_PART_OUT_VALUE { MODELPARAM_VALUE.INT_IMAG_PART_OUT_VALUE PARAM_VALUE.INT_IMAG_PART_OUT_VALUE } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.INT_IMAG_PART_OUT_VALUE}] ${MODELPARAM_VALUE.INT_IMAG_PART_OUT_VALUE}
}
