...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "POINT_POS" -parent ${Page_0}
...
proc update_PARAM_VALUE.POINT_POS { PARAM_VALUE.POINT_POS } {
	# Procedure called to update POINT_POS when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.POINT_POS { PARAM_VALUE.POINT_POS } {
	# Procedure called to validate POINT_POS
	return true
}
...
proc update_MODELPARAM_VALUE.POINT_POS { MODELPARAM_VALUE.POINT_POS PARAM_VALUE.POINT_POS } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.POINT_POS}] ${MODELPARAM_VALUE.POINT_POS}
}
