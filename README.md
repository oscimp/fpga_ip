...
|firReal              | Finite Impulse Response (FIR) filter with coefficients provided from the processor |data_in    |data_out            |DATA_SIZE(16), NB_COEFF(128), DECIMATE_FACTOR(32), DATA_OUT_SIZE(32), COEFF_SIZE(16)|fir| |
